...
═══ РЕЗУЛЬТАТ НА 28.07 (n=12 из 25) ═══
Правило мин.холда РАБОТАЕТ: 11/12 сделок дожили до начисления (было 27%).
Но открылась причина глубже — собранный фандинг составляет 10% от обещанного
спредом на входе (медиана 6%):

    фандинг факт  +11.9 bps  |  комиссия −22.0  |  basis −14.8  =  −25.0 bps
    при maker 8 bps: −10.9   |  при НУЛЕВЫХ комиссиях: −2.9  ← всё равно минус

Basis один (−14.8) превышает весь собранный фандинг (+11.9), то есть стратегия
убыточна ДАЖЕ при нулевых комиссиях. Значит мейкер-исполнение её не спасёт:
узкое место — не издержки, а испарение спреда до момента выплаты.
Подробности: PROJECT_JOURNEY.md, фаза 21.
