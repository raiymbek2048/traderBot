...
═══ РЕЗУЛЬТАТ НА 29.07 (n=18 из 25) ═══
Правило мин.холда РАБОТАЕТ: 17/18 сделок дожили до начисления (было 27%).
Разложение в bps от нотионала:

    фандинг факт  +14.9  |  комиссия −22.0  |  basis −8.5  =  −15.7 bps
    при maker 8 bps: −1.6 (почти безубыток) | при 0% комиссий: +6.3

Весь минус создаётся комиссией тейкера — при нулевых комиссиях стратегия в плюсе.
Собранный фандинг при этом лишь ~10% от обещанного спредом на входе.

⚠️ ЦИФРЫ ДАНЫ С n, ПОТОМУ ЧТО ВЫВОД УЖЕ РАЗВОРАЧИВАЛСЯ.
На n=12 (28.07) было: фандинг +11.9, basis −14.8, при 0% комиссий −2.9 — и в
документацию попало заключение «убыточен даже при нулевых комиссиях». Шесть
новых сделок развернули неравенство. Разбор: PROJECT_JOURNEY.md, фаза 22,
урок 29. Формальный вердикт — только при n≥25.
